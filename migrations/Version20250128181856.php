...
final class Version20250128181856 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE tickets (id INT AUTO_INCREMENT NOT NULL, project_id INT NOT NULL, assigned_to_id INT DEFAULT NULL, created_by INT NOT NULL, updated_by INT DEFAULT NULL, title VARCHAR(255) NOT NULL, description LONGTEXT NOT NULL, index_number VARCHAR(255) NOT NULL, priority VARCHAR(255) NOT NULL, `order` INT NOT NULL, created_at DATETIME NOT NULL, updated_at DATETIME DEFAULT NULL, deleted_at DATETIME DEFAULT NULL, INDEX IDX_54469DF4166D1F9C (project_id), INDEX IDX_54469DF4F4BD7827 (assigned_to_id), INDEX IDX_54469DF4DE12AB56 (created_by), INDEX IDX_54469DF416FE72E1 (updated_by), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
